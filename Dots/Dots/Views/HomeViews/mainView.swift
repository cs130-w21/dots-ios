                            ...
                            if self.chosenBill != bill {
                                HStack (spacing: gap) {
                                    ...
                                    Button(action: {}) {
                                        ...
                                        .frame(width: editing == bill.id ? (self.draggingOffset.width < 0 ? -0.5 * self.draggingOffset.width - gap : 0) : 0, height: geo.size.height)
                                    ...
                                    Button(action: {}) {
                                        ...
                                        .frame(width: editing == bill.id ? (self.draggingOffset.width < 0 ? -0.5 * (self.draggingOffset.width) + 2 * gap : 0) : 0, height: geo.size.height)
